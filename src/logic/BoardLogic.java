...
public class BoardLogic implements MouseListener{
	...
	// This changes line color
	private int lineColor;
	
	/**
	 * Constructor de la clase BoardLogic que maneja toda la l�gica detr�s del juego.
	 */
	public BoardLogic() {
		...
		organizarCuadrados();
		organizarTriangulos();
		//Crea las l�neas en la interfaz.
		crearLineas();
		
		// Generates matrix dots
	...
	/**
	 * M�todo que determina los distintos tri�ngulos posibles.
	 */
	...
	/**
	 * M�todo que organiza todos los posibles cuadrados.
	 */
	...
	/**
	 * M�todo que crea las distintas lineas que estar�n en pantalla.
	 */
	public void crearLineas() {
		
		//Array structures:
		//{Line color, initial pos X, initial pos Y, final pos X, final pos Y}
